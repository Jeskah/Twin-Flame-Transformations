...
return (
    <div className="relative flex flex-col items-center flex-wrap p-10">
    <div className="border p-6 rounded-xl max-w-sm gap-10 flex flex-col text-white bg-white/5">
